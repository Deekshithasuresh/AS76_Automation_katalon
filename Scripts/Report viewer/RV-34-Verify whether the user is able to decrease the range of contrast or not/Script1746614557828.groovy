...
// wait for PBS list and open first “Under review” report
...
WebUI.delay(2)  // wait for the slider panel
...
// 3) PICK THE CONTRAST THUMB (index 2)
WebElement contrastThumb = allThumbs[2]

// 4) SCROLL IT INTO VIEW & DRAG LEFT
((JavascriptExecutor) driver).executeScript(
	"arguments[0].scrollIntoView(true);", contrastThumb
)
Thread.sleep(500)
