...
def checkCellDotColor = { String cellType ->
    ...
    try {
        ...
        cellObject.addProperty('xpath', ConditionType.EQUALS, ('//div[contains(@class, \'cell-row\') and contains(., \'' + 
            cellType) + '\')]')
        ...
        try {
            ...
            String cellHTML = ((js.executeScript('return arguments[0].outerHTML;', cellElement)) as String)
            ...
            List<String> dotXpaths = ['.//div[contains(@class, \'default\') and contains(@class, \'significant\')]', './/div[contains(@class, \'default\') and contains(@class, \'non-significant\')]'
                , './/div[contains(@class, \'dot\') and contains(@class, \'significant\')]', './/div[contains(@class, \'dot\') and contains(@class, \'non-significant\')]'
                , './/div[contains(@class, \'dot\')]', './/div[contains(@class, \'default\')]']
...
checkCellDotColor('Hypochromic Cells')

checkCellDotColor('Polychromatic Cells')
...
Map<String, String> cellXPaths = [('Hypochromic Cells') : '//div[contains(@class, \'reportSummary_pane-body__table-row__name__XCUeF\') and .//span[text()=\'Hypochromic Cells\']]'
    , ('Polychromatic Cells') : '//div[contains(@class, \'reportSummary_pane-body__table-row__name__XCUeF\') and .//span[text()=\'Polychromatic Cells\']]']
...
def verifyInSummaryTab = { String cellType ->
    ...
    try {
        ...
        if (shouldBePresent && isPresent) {
            println(('PASS: ' + cellType) + ' is significant (red) and correctly present in Summary Tab') // Additional debugging for when an element should be present but isn't
...
verifyInSummaryTab('Hypochromic Cells')

verifyInSummaryTab('Polychromatic Cells')
