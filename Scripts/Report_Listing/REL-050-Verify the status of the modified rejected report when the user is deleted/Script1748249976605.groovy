...
WebUI.setEncryptedText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/input_Password_loginPassword'), 
...
WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/Page_PBS/input_New password_new-password'), 
    password)

WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/Page_PBS/input_Confirm password_confirm-password'), 
    password)
...
WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_PBS/div_Templates_ql-editor ql-blank dx-htmledi_1a290a'), 
    rbcText)
...
TestObject tableRow = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//tbody[contains(@class,\'MuiTableBody-root\')]/tr')
...
if (results.size() > 0) {
    ...
    String scanDateTextAfterAproval = columns.get(4).getText().trim()

    String status = columns.get(5).getText().trim()
