...
//}
	...
	WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/input_Name_rbc-input-box'), secondName)
	WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/input_Email_rbc-input-box error'), secondEmail)
	WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/input_Username_rbc-input-box'), secondName)
	WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/input_Password_rbc-input-box'), password)
	WebUI.click(findTestObject('Object Repository/Report_Listing/Page_Admin Console/input_Reviewer_userRole'))
	WebUI.verifyElementText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/button_Create new user'), 'Create new user')
	WebUI.click(findTestObject('Object Repository/Report_Listing/Page_Admin Console/button_Create new user'))
	...
	//delete second user
	WebUI.setText(findTestObject('Object Repository/Report_Listing/Page_Admin Console/Page_Admin Console/search_field'), secondName)
