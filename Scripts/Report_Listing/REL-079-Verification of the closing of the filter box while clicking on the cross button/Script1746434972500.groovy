...
WebUI.verifyElementPresent(findTestObject('Object Repository/Report_Listing/Page_PBS/button_Filters_MuiButtonBase-root MuiIconBu_2f02cd'), 5, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Object Repository/Report_Listing/Page_PBS/button_Filters_MuiButtonBase-root MuiIconBu_2f02cd'))


WebUI.verifyElementNotPresent(findTestObject('Object Repository/Report_Listing/Page_PBS/span_Filters'),10)
