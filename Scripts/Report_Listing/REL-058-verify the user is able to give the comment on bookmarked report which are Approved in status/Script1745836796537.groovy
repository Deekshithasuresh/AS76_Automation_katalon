...
WebUI.verifyElementText(findTestObject('null'), 'Approved')
...
WebUI.setText(findTestObject('null'), 'test1')

WebUI.setText(findTestObject('null'), 'test12')
...
WebUI.verifyElementText(findTestObject('null'), 'test123')
