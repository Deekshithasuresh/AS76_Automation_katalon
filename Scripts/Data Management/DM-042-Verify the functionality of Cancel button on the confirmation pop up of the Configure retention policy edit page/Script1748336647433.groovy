...
TestObject cancelBtnPopup = new TestObject("cancelBtnPopup")
cancelBtnPopup.addProperty("xpath", ConditionType.EQUALS, "/html[1]/body[1]/div[3]/div[3]/div[3]/button[1]")
WebUI.click(cancelBtnPopup)
...
assert finaldaysValue == currentValueStr : "Expected '${currentValueStr}, got '${daysValue}'"
