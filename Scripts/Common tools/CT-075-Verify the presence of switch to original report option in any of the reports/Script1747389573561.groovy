...
WebUI.click(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/div_16-May-2025, 0249 PM (IST)'))

WebUI.click(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/img'))

WebUI.verifyElementPresent(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/li_Switch to original report'), 0)
