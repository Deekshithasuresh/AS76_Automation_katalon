...
WebUI.verifyElementPresent(findTestObject('Object Repository/Commontools/span_Switch to original report (1)'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Commontools/span_Switch to original report (1)'), 'Switch to original report')
