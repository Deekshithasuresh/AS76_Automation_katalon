...
WebUI.click(findTestObject('Object Repository/Commontools/span_CBC report'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Commontools/button_CBC report'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Commontools/span_CBC report_1'), 'CBC report')
