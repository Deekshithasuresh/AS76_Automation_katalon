...
WebUI.click(findTestObject('Object Repository/Commontools/Page_PBS/div_16-May-2025, 1005 AM (IST)'))

WebUI.click(findTestObject('Object Repository/Commontools/Page_PBS/button_WBC'))

WebUI.verifyElementText(findTestObject('Object Repository/Commontools/Page_PBS/button_WBC'), 'WBC')

WebUI.click(findTestObject('Object Repository/Commontools/Page_PBS/div_CBC report'))
