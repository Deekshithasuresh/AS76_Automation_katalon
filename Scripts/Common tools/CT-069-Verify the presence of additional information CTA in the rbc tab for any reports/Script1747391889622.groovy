...
WebUI.click(findTestObject('Object Repository/Commontools/Page_PBS/td_18123-MGG-C'))

WebUI.click(findTestObject('Object Repository/Commontools/Page_PBS/span_RBC'))

WebUI.verifyElementText(findTestObject('Object Repository/Commontools/Page_PBS/span_RBC'), 'RBC')
WebUI.rightClick(findTestObject('WBC/Page_PBS/Page_PBS/1stPatch'))

WebUI.verifyTextNotPresent('Additional info', false)
