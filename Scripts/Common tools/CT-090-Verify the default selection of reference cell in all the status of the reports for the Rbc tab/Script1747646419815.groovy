...
WebUI.click(findTestObject('Object Repository/Commontools/Page_PBS/div_References (7)'))

WebUI.click(findTestObject('Object Repository/Commontools/Page_PBS/div_References (7)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Commontools/Page_PBS/div_Microcytes (1)'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Commontools/Page_PBS/div_Microcytes (1)'), 'Microcytes')
