...
WebUI.click(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/div_22-Apr-2025, 0640 PM (IST)'))
...
WebUI.verifyElementText(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/td_Large Granular Lymphocytes'), 'Large Granular Lymphocytes*')
