...
WebDriver driver = DriverFactory.getWebDriver()
	...
	WebElement inTotalRow = driver.findElement(By.xpath("//td[normalize-space()='Total']/following-sibling::td[1]"))
	int inWbcCount = Integer.parseInt(inTotalRow.getText().trim())
	if(inWbcCount >= 200) {
		int reclassify=inWbcCount-199
		//WebUI.refresh()
		WebUI.click(findTestObject('Object Repository/Report_Listing/Page_PBS/span_WBC'))
	...
	int wbcCount = Integer.parseInt(inTotalRow.getText().trim())
	...
	if (!warningOnSummary) {
		...
		WebUI.comment(" Warning  visible on Summary tab")
	}
