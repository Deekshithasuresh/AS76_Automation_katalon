...
neutrophilRow.addProperty("xpath", ConditionType.EQUALS, "//td[contains(text(),'Lymphocytes')]")
...
CustomKeywords.'generic.Reclassification.dragAndDropMultipleSelectedPatches'("Neutrophils", "Lymphocytes", 3)
