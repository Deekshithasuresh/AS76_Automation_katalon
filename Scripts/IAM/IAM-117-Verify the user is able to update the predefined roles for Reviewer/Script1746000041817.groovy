...
String Exp_username = 'UserEwaGgi'
...
//
//WebUI.sendKeys(findTestObject('Object Repository/Manage_user/Page_Admin Console/input_Name_rbc-input-box'), 'tester')
//
...
//        Keys.BACK_SPACE))
//
//WebUI.sendKeys(findTestObject('Object Repository/Manage_user/Page_Admin Console/input_Email_rbc-input-box'), 'testadmin@123.com')
//
...
WebUI.click(findTestObject('IAM Model/Page_Admin Console/label_Operator'))
