...
WebUI.verifyElementText(findTestObject('Object Repository/IAM Model/Page_Admin Console/h2_Confirm to cancel'), 'Confirm to cancel')

WebUI.verifyElementText(findTestObject('Object Repository/IAM Model/Page_Admin Console/div_Are you sure you want to cancel'), 
    'Are you sure you want to cancel?')

WebUI.click(findTestObject('Object Repository/IAM Model/Page_Admin Console/div_Confirm to cancelAre you sure you want _e6f14c'))

WebUI.verifyElementText(findTestObject('Object Repository/IAM Model/Page_Admin Console/button_No'), 'No')

WebUI.verifyElementText(findTestObject('Object Repository/IAM Model/Page_Admin Console/button_Yes'), 'Yes')

WebUI.click(findTestObject('Object Repository/IAM Model/Page_Admin Console/button_No'))

WebUI.click(findTestObject('Object Repository/IAM Model/Page_Admin Console/button_Cancel'))

WebUI.click(findTestObject('Object Repository/IAM Model/Page_Admin Console/button_Yes'))
