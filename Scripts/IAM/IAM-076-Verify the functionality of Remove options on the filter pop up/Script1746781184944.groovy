...
//steps for showing the selected filters for all users.
...
WebUI.click(findTestObject('Object Repository/View list of users/Page_Admin Console/button_Remove all'))
