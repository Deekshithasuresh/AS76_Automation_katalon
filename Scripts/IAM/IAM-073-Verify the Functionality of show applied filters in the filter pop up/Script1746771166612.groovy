...
//steps for showing the selected filters for all roles and operators.
...
WebUI.click(findTestObject('Object Repository/View list of users/Page_Admin Console/button_Show applied filters'))

WebUI.click(findTestObject('Object Repository/View list of users/Page_Admin Console/img_1'))
