...
WebUI.click(findTestObject('Object Repository/IAM Model/Page_Admin Console/input_Select role_userRole'))

WebUI.click(findTestObject('Object Repository/IAM Model/Page_Admin Console/input_Operator_userRole'))
