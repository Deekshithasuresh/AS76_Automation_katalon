...
// steps for status filter for admin
ApplyFilterAndVerifyTheList applyFilter = new ApplyFilterAndVerifyTheList()

applyFilter.applyRoleAndStatusFiltersM(['administrator'], ['Active', 'Inactive'])

applyFilter.verifyFilteredUsersByRoleAndStatusM(['administrator'], ['Active', 'Inactive'])
