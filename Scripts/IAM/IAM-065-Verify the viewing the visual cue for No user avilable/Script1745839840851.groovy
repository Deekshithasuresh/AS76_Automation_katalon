...
String searchKeyword = 'pawan,Roo'

String Exp_username = 'Orre'

String Exp_role = 'administrator'

String Exp_Status = 'Active'

String searchKeywordForIn_ActiveUser = 'test'

String Exp_InActive_username = 'testt'

String Exp_InActive_role = 'administrator'

String Exp_InActive__Status = 'InActive'

String RoleBasedSearchKeyword = 'test'

String SearchKeywordForNoResultsFound = 'qwfdwefnaknwrklef'

verifySearchUserByUsernameAndRole(searchKeyword, Exp_username, Exp_role, Exp_Status)

verifySearchUserByUsernameAndRole(searchKeywordForIn_ActiveUser, Exp_InActive_username, Exp_InActive_role, Exp_InActive__Status)

verifySearchUserByUsernameAndRole(SearchKeywordForNoResultsFound, Exp_username, Exp_role, Exp_Status //search by roll acesss
...
void verifySearchUserByUsernameAndRole(String keyword, String username, String role, String status) {
    ...
    if (rowCount == 0) {
        println('No users found for searched keyword ' + keyword)
    }
