...
WebUI.sendKeys(findTestObject('Object Repository/Manage_user/Page_Admin Console/input_Name_rbc-input-box'), 'pawan kumar')
...
WebUI.click(findTestObject('Object Repository/Manage_user/Page_Admin Console/input_Operator_userRole'))
...
// === Customize your expected dynamic message here ===
String expectedupdatePartial = 'has been successfully updated'
