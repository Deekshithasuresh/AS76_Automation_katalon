...
WebUI.getAttribute(findTestObject('IAM Model/Page_Admin Console/p_Username'),uniqueUsername)

WebUI.verifyElementText(findTestObject('Object Repository/IAM Model/Page_Admin Console/p_Password'), 'Password')

WebUI.getAttribute(findTestObject('IAM Model/Page_Admin Console/p_Password'), 'Admin@123')
