...
// steps for status filter for operator

ApplyFilterAndVerifyTheList applyFilter = new ApplyFilterAndVerifyTheList()

applyFilter.applyRoleAndStatusFiltersM(['operator', ], ['Active', 'Inactive'])
applyFilter.verifyFilteredUsersByRoleAndStatusM(['operator', ], ['Active', 'Inactive'])
