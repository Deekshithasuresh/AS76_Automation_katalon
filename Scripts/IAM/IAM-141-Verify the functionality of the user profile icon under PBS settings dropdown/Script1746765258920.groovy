...
//Script for verifying the  profile icon options  details from the  pbs settings.
...
WebUI.click(findTestObject('Admin-Profile-icon/Page_Admin Console/img'))

WebUI.verifyElementText(findTestObject('Admin-Profile-icon/Page_Admin Console/li_Time zone'), 'Time zone')

WebUI.verifyElementText(findTestObject('Admin-Profile-icon/Page_Admin Console/li_Change password'), 'Change password')

WebUI.verifyElementText(findTestObject('Admin-Profile-icon/Page_Admin Console/li_Logout'), 'Logout')
