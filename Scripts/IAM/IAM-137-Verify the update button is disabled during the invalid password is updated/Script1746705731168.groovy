...
//Scripts for verifying the error message when the user add the wrong formate password.
...
WebUI.sendKeys(findTestObject('View list of users/Page_Admin Console/input_Password_rbc-input-box'), 'Sigtup1234')

WebUI.verifyElementText(findTestObject('Manage_user/Page_Admin Console/div_Password must be 8 chars, with letters, numbers, and a special char'), 
    'Password must be 8+ chars, with letters, numbers, and a special char.', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.getCSSValue(findTestObject('Manage_user/Page_Admin Console/div_Password must be 8 chars, with letters, numbers, and a special char'), 
    'color')
