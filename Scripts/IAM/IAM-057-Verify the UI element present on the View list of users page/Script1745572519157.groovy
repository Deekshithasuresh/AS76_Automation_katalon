...
WebUI.verifyElementText(findTestObject('Object Repository/View list of users/Page_Admin Console/button_Clear filters'), 
    'Clear filters')

WebUI.verifyElementText(findTestObject('Object Repository/View list of users/Page_Admin Console/button_Create User'), 'Create User')

WebUI.verifyElementText(findTestObject('Object Repository/View list of users/Page_Admin Console/th_Name'), 'Name')

WebUI.verifyElementText(findTestObject('Object Repository/View list of users/Page_Admin Console/th_User name'), 'User name')

WebUI.verifyElementText(findTestObject('Object Repository/View list of users/Page_Admin Console/th_Role'), 'Role')

WebUI.verifyElementText(findTestObject('Object Repository/View list of users/Page_Admin Console/th_Status'), 'Status')
