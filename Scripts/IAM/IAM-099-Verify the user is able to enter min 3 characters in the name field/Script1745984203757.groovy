...
WebUI.sendKeys(findTestObject('Object Repository/IAM Model/Page_Admin Console/input_Name_rbc-input-box'), 'paw!')

WebUI.waitForElementVisible(findTestObject('IAM Model/Page_Admin Console/div_Only these special characters , . -   a_335dbb'), 
    10)

WebUI.verifyElementText(findTestObject('IAM Model/Page_Admin Console/div_Only these special characters , . -   a_335dbb'), 
    'Only these special characters , . - \' " are allowed')

WebUI.getCSSValue(findTestObject('Object Repository/IAM Model/Page_Admin Console/div_Only these special characters , . -   a_335dbb'), 
    'color')
