...
//String searchkeyword_byusername = 'admin test'
...
//verifySearchUserByUsernameAndRole(searchkeyword_byusername, Exp_username, Exp_role, Exp_Status //search by roll acesss )
...
//String expectedTextPart = 'user deleted'
//int timeout = 30
//TestObject toastObject = new TestObject('toast')
//toastObject.addProperty('xpath', ConditionType.EQUALS, '//div[contains(@class, \'Toastify__toast\') or contains(text(), \'successfully\')]')
//if (WebUI.waitForElementPresent(toastObject, timeout)) {
//    String actualText = WebUI.getText(toastObject).trim()
//   WebUI.comment("✅ Toast Text: '$actualText'")
//   if (actualText.contains(expectedTextPart)) {
//      KeywordUtil.markPassed("✅ Expected toast appeared: '$actualText'")
//  } else {
// KeywordUtil.markFailed("⚠️ Toast text mismatch. Expected: '$expectedTextPart'. Got: '$actualText'")
// }
//} else {
//   KeywordUtil.markFailed("❌ Toast not found within $timeout seconds.")
//}
...
WebUI.setText(findTestObject('Object Repository/Manage_user/Page_Admin Console/input_Username_loginId'), 'UserycLUnx')
