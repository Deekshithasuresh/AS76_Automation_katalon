...
WebUI.click(findTestObject('Manage_user/Page_Admin Console/button_No'))

//Clicking some where on the screen
WebDriver driver1 = DriverFactory.getWebDriver()

Actions actions = new Actions(driver)

// This clicks near the top-left corner (x=10, y=10)
actions.moveByOffset(10, 10).click().perform()

// Optionally wait after the click
WebUI.delay(1)
