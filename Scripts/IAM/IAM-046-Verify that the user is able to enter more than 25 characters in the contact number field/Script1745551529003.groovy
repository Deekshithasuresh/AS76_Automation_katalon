...
WebUI.click(findTestObject('Object Repository/IAM Model/Page_Admin Console/Contact_number_field'))

WebUI.sendKeys(findTestObject('Object Repository/IAM Model/Page_Admin Console/Contact_number_field'), findTestData('Contact_1').getValue(
        1, 20))

WebUI.verifyElementText(findTestObject('Object Repository/IAM Model/Page_Admin Console/div_Maximum 25 characters allowed'), 
