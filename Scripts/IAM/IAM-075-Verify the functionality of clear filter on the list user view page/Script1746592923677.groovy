...
//WebUI.click(findTestObject('View list of users/Page_Admin Console/label_Operator'))
//WebUI.click(findTestObject('View list of users/Page_Admin Console/button_Status'))
//WebUI.click(findTestObject('View list of users/Page_Admin Console/label_Active'))
//WebUI.click(findTestObject('View list of users/Page_Admin Console/label_Inactive'))
//WebUI.click(findTestObject('View list of users/Page_Admin Console/button_Apply'))
...
applyFilter.applyRoleAndStatusFilters('administrator', 'InActive')

applyFilter.verifyFilteredUsersByRoleAndStatus('administrator', 'InActive')
