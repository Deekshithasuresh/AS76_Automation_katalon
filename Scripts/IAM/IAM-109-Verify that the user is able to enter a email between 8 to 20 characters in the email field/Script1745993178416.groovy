...
WebUI.sendKeys(findTestObject('Object Repository/IAM Model/Page_Admin Console/input_Email_rbc-input-box'), 'autotester2024@example.com')

WebUI.getAttribute(findTestObject('IAM Model/Page_Admin Console/input_Email_rbc-input-box'), 'value')
