...
WebUI.sendKeys(findTestObject('Object Repository/Manage_user/Page_Admin Console/input_Name_rbc-input-box'), 'pawan')
...
WebUI.sendKeys(findTestObject('Object Repository/Manage_user/Page_Admin Console/input_Email_rbc-input-box'), 'testas76admin@123.com')
...
WebUI.click(findTestObject('Object Repository/Manage_user/Page_Admin Console/button_Update'))

WebUI.verifyElementText(findTestObject('Object Repository/Manage_user/Page_Admin Console/h2_Share the Credentials'), 'Share the Credentials')

WebUI.verifyElementText(findTestObject('Object Repository/Manage_user/Page_Admin Console/p_Please share the credentials to the regis_554608'), 
    'Please share the credentials to the registered user')

WebUI.click(findTestObject('Object Repository/Manage_user/Page_Admin Console/p_Username'))

WebUI.verifyElementText(findTestObject('Object Repository/Manage_user/Page_Admin Console/p_Username'), 'Username')

WebUI.verifyElementText(findTestObject('Object Repository/Manage_user/Page_Admin Console/p_Password'), 'Password')

WebUI.verifyElementText(findTestObject('Object Repository/Manage_user/Page_Admin Console/button_Cancel'), 'Cancel')

WebUI.verifyElementText(findTestObject('Object Repository/Manage_user/Page_Admin Console/button_Update and copy'), 'Update and copy')

WebUI.click(findTestObject('Object Repository/Manage_user/Page_Admin Console/button_Update and copy'))

////toast message
//String expectedPartial = 'has been successfully updated'
//
//int timeout = 20
//
//// === Define Toast TestObject based on your structure ===
...
// === Wait for the toast to appear ===
if (WebUI.waitForElementPresent(updatetoastObject, timeout)) {
	String toastText = WebUI.getText(updatetoastObject)

	// Normalize white space
	toastText = toastText.replaceAll('\\s+', ' ').trim()
