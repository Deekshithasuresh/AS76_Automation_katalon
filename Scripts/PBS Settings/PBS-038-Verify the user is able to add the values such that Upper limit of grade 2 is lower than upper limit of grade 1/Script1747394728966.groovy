...
WebUI.waitForElementPresent(findTestObject('PBS_Settings_Objects/Page_Admin Console/div_PBS settings'), 10)
...
pbs_set.EneterValueInUpperLimitFields('6', '4', 'checkErrorMessage')
