...
wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[text()='Reject report']")));
driver.findElement(By.xpath("//button[text()='Reject report']")).click()

wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='modal-actions']/button[text()='Reject report']")));
driver.findElement(By.xpath("//div[@class='modal-actions']/button[text()='Reject report']")).click()
