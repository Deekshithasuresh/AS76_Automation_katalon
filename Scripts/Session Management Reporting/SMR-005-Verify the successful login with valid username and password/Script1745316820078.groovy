...
WebUI.verifyElementPresent(findTestObject('Object Repository/Session management reporting/Page_PBS/input_username_loginId'), 
    30)

WebUI.verifyElementPresent(findTestObject('Object Repository/Session management reporting/Page_PBS/input_password_loginPassword'), 
    30)
...
WebUI.verifyElementPresent(findTestObject('Session management reporting/Page_PBS/hide_password_img'), 30)

WebUI.verifyElementClickable(findTestObject('Session management reporting/Page_PBS/hide_password_img'))
...
WebUI.verifyElementClickable(findTestObject('Session management reporting/Page_PBS/button_Sign In_for_PBS login'))
