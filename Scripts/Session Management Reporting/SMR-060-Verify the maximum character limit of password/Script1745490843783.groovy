...
WebUI.setText(findTestObject('Object Repository/Session management reporting/Page_PBS/input_New password_new-password'), 
    'UnlockYourPotentialEveryDayStartWithOneSmallStepAndKeepMovingForward@123451234512')

String number_of_characters = WebUI.getAttribute(findTestObject('Object Repository/Session management reporting/Page_PBS/input_New password_new-password'), 
    'value')
