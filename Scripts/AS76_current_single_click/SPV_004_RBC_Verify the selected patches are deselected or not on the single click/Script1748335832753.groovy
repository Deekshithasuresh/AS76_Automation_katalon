...
try {
    ...
    if (patches.size() == 0) {
        println('No cells available in RBC SIZE') // First click to select patch
        // Verify selection
...
try {
    ...
    if (patches.size() == 0) {
        println('No cells available in RBC SHAPE') // First click to select patch
        // Verify selection
        // Second click to deselect patch
        // Verify deselection
    } else {
...
try {
    ...
    if (patches.size() == 0) {
        println('No cells available in RBC COLOR') // First click to select patch
        // Verify selection
        // Second click to deselect patch
        // Verify deselection
    } else {
...
try {
    ...
    if (patches.size() == 0) {
        println('No cells available in RBC INCLUSIONS') // First click to select patch
        // Verify selection
        // Second click to deselect patch
        // Verify deselection
    } else {
