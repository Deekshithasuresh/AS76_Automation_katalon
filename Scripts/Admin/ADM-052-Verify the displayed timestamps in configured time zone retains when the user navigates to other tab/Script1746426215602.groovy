...
WebUI.verifyElementText(findTestObject('Object Repository/Session management reporting/Page_Admin Console/span_(UTC0000) AfricaBamako'), 
...
WebUI.verifyElementText(findTestObject('Session management reporting/Page_Admin Console/h2_Admin Portal'), 'Admin Portal')

WebUI.click(findTestObject('Session management reporting/Page_Admin Console/div_PBS settings'))

WebUI.click(findTestObject('Object Repository/Session management reporting/Page_Admin Console/button_RBC grade limits'))
...
WebUI.click(findTestObject('Object Repository/Session management reporting/Page_Admin Console/div_'))

WebUI.click(findTestObject('Object Repository/Session management reporting/Page_Admin Console/li_(UTC0100) AfricaBangui'))
