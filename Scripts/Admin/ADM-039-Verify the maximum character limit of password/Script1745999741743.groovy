...
WebUI.setText(findTestObject('Object Repository/Session management reporting/Page_Admin Console/input_New password_new-password'), 
    'Thisisaverylongsentencethatcontainsonehundredcharacterswithoutanyspaceswhatso@11ever')

String number_of_characters = WebUI.getAttribute(findTestObject('Object Repository/Session management reporting/Page_Admin Console/input_New password_new-password'), 
    'value')

String characters = number_of_characters.length()
