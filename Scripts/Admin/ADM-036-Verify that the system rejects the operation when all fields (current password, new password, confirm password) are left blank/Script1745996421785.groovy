...
WebUI.click(findTestObject('Session management reporting/Page_Admin Console/input_New password_new-password'))

WebUI.click(findTestObject('Object Repository/Session management reporting/Page_Admin Console/div_Change passwordCurrent passwordCurrent _886300'))
...
WebUI.verifyElementNotClickable(findTestObject('Session management reporting/Page_Admin Console/button_Confirm password'))
