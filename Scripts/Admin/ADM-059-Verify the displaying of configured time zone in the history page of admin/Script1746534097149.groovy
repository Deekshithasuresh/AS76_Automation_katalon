...
Map<String, String> abbreviationToOffset = [ "IST": "+05:30", "UTC": "+00:00", "GMT": "+00:00", "CET": "+01:00", "EET": "+02:00", "MSK": "+03:00", "AST": "-04:00", "EST": "-05:00", "CST": "-06:00", "MST": "-07:00", "PST": "-08:00" ]
...
def verifyTimeZone(String timeZoneOptionTestObject, String selectedZoneTO, String historyEntryTO, Map<String,String> abbrMap) {
	...
	assert normalizedHistoryOffset == selectedOffset :
		"❌ Expected $selectedOffset but got $normalizedHistoryOffset"
...
WebUI.setText(findTestObject('Object Repository/Session management reporting/Page_Admin Console/input_Password_loginPassword'), 'jyothi@1995')
...
verifyTimeZone(
	'Object Repository/Session management reporting/Page_Admin Console/li_(UTC0300) AsiaBahrain',
	'Object Repository/Session management reporting/Page_Admin Console/li_(UTC0300) AsiaBahrain',
	'Object Repository/Session management reporting/Page_Admin Console/div_07-May-2025, 0752 AM (03)',
