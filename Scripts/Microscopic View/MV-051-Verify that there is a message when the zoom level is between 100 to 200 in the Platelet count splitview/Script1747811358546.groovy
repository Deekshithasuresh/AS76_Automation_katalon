...
WebUI.waitForElementClickable(underReview, 10, FailureHandling.OPTIONAL)
WebUI.scrollToElement(underReview, 3, FailureHandling.OPTIONAL)
WebUI.click(underReview, FailureHandling.OPTIONAL)

// ────────────────────────────────────────────────────────────────────
// 4) NAVIGATE to Platelets → Split view
// ────────────────────────────────────────────────────────────────────
...
WebUI.delay(3)  // give split‐view time to render

// ────────────────────────────────────────────────────────────────────
// 5) SETUP ZOOM‐IN & WARNING LOCATORS
// ────────────────────────────────────────────────────────────────────
int maxClicks = 10
...
def zoomWarning = new TestObject().addProperty('xpath', ConditionType.EQUALS,
	"//div[contains(text(),'100 to 200')]")  // adjust text as needed

// ────────────────────────────────────────────────────────────────────
// 6) CLICK ZOOM IN UNTIL WARNING OR EXHAUST MAX
// ────────────────────────────────────────────────────────────────────
boolean warningFound = false
for (int i = 1; i <= maxClicks; i++) {
	if (!WebUI.waitForElementClickable(zoomInBtn, 5, FailureHandling.OPTIONAL)) {
		WebUI.comment("⚠️ Zoom‐in button not clickable at iteration ${i}; stopping.")
		break
	}
...
// 7) CLEAN UP
// ────────────────────────────────────────────────────────────────────
WebUI.comment("✅ MV-051 execution complete.")
