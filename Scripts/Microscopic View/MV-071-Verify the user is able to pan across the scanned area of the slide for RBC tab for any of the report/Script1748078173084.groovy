...
saveBase64Image(beforePan, 'rbc_before_pan.png')
...
saveBase64Image(afterPan, 'rbc_after_pan.png')

// ─── STEP 8: Compare base64 data ─────────────────────────────────
if (beforePan == afterPan) {
	WebUI.comment("❌ RBC canvas did NOT change — pan may have failed.")
} else {
	WebUI.comment("✅ RBC canvas changed — pan succeeded.")
}
