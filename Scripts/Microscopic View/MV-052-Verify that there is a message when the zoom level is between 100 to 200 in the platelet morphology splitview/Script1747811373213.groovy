...
TestObject morphologyTab = new TestObject().addProperty('xpath', ConditionType.EQUALS,
...
WebUI.comment("✔ Morphology tab clicked under Platelets.")
// ---------- STEP 3: Activate Split view ----------
...
for (int i = 0; i < maxClicks; i++) {
    ...
    if (WebUI.verifyElementPresent(zoomWarning, 1, FailureHandling.OPTIONAL)) {
        WebUI.comment("✔ Zoom warning appeared after ${i + 1} clicks in Platelet Morphology split view.")
        break
    }
}