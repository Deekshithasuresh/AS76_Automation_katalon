...
// ────────────────────────────────────────────────────────────────────
// Helper to take a screenshot and return its full Base64 string
...
// ────────────────────────────────────────────────────────────────────
// STEP 8: Wait 90s for the 40× view to stabilize, then capture screenshot + Base64
WebUI.delay(90)
String shot40 = "rbc_40x_view.png"
String base64_40x = snapAndBase64(shot40)
println "FULL Base64 40× view (RBC): ${base64_40x}"

WebUI.comment("✅ 40× mark-area flow on RBC tab complete.")
