...
TestObject btn100x = new TestObject().addProperty('xpath', ConditionType.EQUALS, '(//button[.//img[@alt=\'zoom-tool\']]/following::button)[2]')
...
WebUI.comment(flashed ? '✔ Info message flashed after 100× click' : '⚠ Info message did NOT appear')
