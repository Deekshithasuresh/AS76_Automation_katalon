...
// ---------- STEP 6: Verify the Overview (›) navigation button ----------
TestObject overviewBtnPL = new TestObject().addProperty(
	'xpath', ConditionType.EQUALS,
	"//button[@title='Overview']"
)
WebUI.verifyElementPresent(overviewBtnPL, 10)
WebUI.comment("✔ Overview navigation button is present on Platelets microscopic view.")
