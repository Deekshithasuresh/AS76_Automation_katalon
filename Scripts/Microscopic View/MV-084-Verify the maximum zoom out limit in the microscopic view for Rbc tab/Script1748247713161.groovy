...
// STEP 6: Zoom in 4× with 60s between
...
// STEP 7: Zoom out 4× with 60s, capture screenshot + Base64 each time
...
(1..4).each { i ->
	...
	String b64 = snapAndBase64("rbc_zoomOut${i}.png")
	println "BASE64 zoom-out ${i}: ${b64}"
}

// STEP 8: Fifth zoom-out should return to 1000 μm
WebUI.click(zoomOutBtn)
WebUI.delay(60)
String finalScale = fetchScale()
WebUI.verifyMatch(finalScale, '1000 μm', false, FailureHandling.STOP_ON_FAILURE)
println "Final scale (should be 1000 μm): ${finalScale}"
String b64final = snapAndBase64("rbc_zoomOut5_1000um.png")
println "BASE64 zoom-out 5 (1000 μm): ${b64final}"

WebUI.comment("✅ Completed RBC zoom in/out verification.")
