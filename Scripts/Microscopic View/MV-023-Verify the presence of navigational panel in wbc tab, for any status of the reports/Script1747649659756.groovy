...
// ---------- STEP 5: Wait for the OpenLayers viewer to render ----------
WebUI.delay(5)

// ---------- STEP 6: Verify the Overview (navigation) button is present ----------
TestObject overviewBtn = new TestObject().addProperty(
	'xpath', ConditionType.EQUALS,
	"//button[@title='Overview']"
)
WebUI.verifyElementPresent(overviewBtn, 10)
WebUI.comment("✔ Overview (›) navigation button is present on WBC microscopic view.")
