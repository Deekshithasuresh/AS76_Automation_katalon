...
// ---------- STEP X: Verify stitched‐image canvas is visible ----------
TestObject stitchedCanvas = new TestObject().addProperty(
    'xpath', ConditionType.EQUALS,
    "//div[@class='ol-layer']/canvas"
)
WebUI.waitForElementVisible(stitchedCanvas, 10)
WebUI.verifyElementVisible(stitchedCanvas)
WebUI.comment("Stitched microscopic image canvas is present and visible.")
