...
// ─── 4) SWITCH TO RBC TAB ───────────────────────────────────────────────
TestObject rbcTab = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//button[contains(@class,\'cell-tab\')]//span[normalize-space()=\'RBC\']')
...
TestObject zoomInBtn = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//button[contains(@class,\'ol-zoom-in\') and @title=\'Zoom in\']')

TestObject zoomWarn = new TestObject().addProperty('xpath', ConditionType.EQUALS, '//div[contains(@class,\'zoom-warning\') and contains(.,\'Digital zoom only\')]')
