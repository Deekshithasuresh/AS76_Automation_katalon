...
// Verify the Details of the multiplicator  factor pop up.
WebUI.verifyElementText(findTestObject('Object Repository/Platelet/Page_PBS/div_Multiplication factor'), 'Multiplication factor')

WebUI.verifyElementText(findTestObject('Object Repository/Platelet/Page_PBS/p_Enter a value between 5000 and 50000'), 
    'Enter a value between 5000 and 50000')

WebUI.verifyElementPresent(findTestObject('Object Repository/Platelet/Page_PBS/Multiplication-input-box'), 0)

WebUI.verifyElementText(findTestObject('Object Repository/Platelet/Page_PBS/div_Default for all your future reports'), 
    'Default for all your future reports')

WebUI.verifyElementText(findTestObject('Object Repository/Platelet/Page_PBS/button_Cancel'), 'Cancel')
