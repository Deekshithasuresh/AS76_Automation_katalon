...
//verfiying the presence of count header,cellname header,avgcount heder,percentage header.
...
WebUI.verifyElementText(findTestObject('Object Repository/Platelet/Page_PBS/th_Avg Count 100X FOV'), 'Avg Count/ 100X FOV')

WebUI.verifyElementPresent(findTestObject('Object Repository/Platelet/Page_PBS/th_'), 0)
