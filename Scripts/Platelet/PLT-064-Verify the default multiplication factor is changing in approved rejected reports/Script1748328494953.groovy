...
WebUI.click(findTestObject('Object Repository/Platelet/Page_PBS/button_Approve report-main report page'))

//findTestObject('Object Repository/Platelet/Page_PBS/button_Approve report-main report page')
WebUI.click(findTestObject('Object Repository/Platelet/Page_PBS/button_Confirm-confirm pop up'))

//findTestObject('Object Repository/Platelet/Page_PBS/button_Confirm-confirm pop up')

WebUI.click(findTestObject('Object Repository/Platelet/Page_PBS/span_Approve report'))

WebUI.click(findTestObject('Object Repository/Platelet/Page_PBS/button_Approve report_1'))
...
// Dynamically create the TestObject for the multiplication factor display
TestObject multiplicationFactorDisplay_Approved = new TestObject()
...
// Dynamically create the TestObject for the multiplication factor display
TestObject multiplicationFactorDisplay2 = new TestObject()
...
WebUI.click(findTestObject('Object Repository/Platelet/Page_PBS/button_Reject report- main -report'))

WebUI.click(findTestObject('Object Repository/Platelet/Page_PBS/button_Reject report-confirm popu'))
...
// Dynamically create the TestObject for the multiplication factor display
TestObject multiplicationFactorDisplay_rejected = new TestObject()
