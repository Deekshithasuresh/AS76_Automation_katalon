...
//verifying the presence and selection of Manual level 
WebUI.verifyElementText(findTestObject('Platelet/Page_PBS/label_Manual level'), 'Manual level')

WebUI.click(findTestObject('Object Repository/Platelet/Page_PBS/Manual_radio_box_ selection'))

//verifying the content after selecting manual radio button
WebUI.verifyElementPresent(findTestObject('Object Repository/Platelet/Page_PBS/td_Manual levelPlatelet count levelSignificantly decreased'), 10)
