...
checkCellDotColor('Ovalocytes')
checkCellDotColor('Elliptocytes')
checkCellDotColor('Teardrop Cells')
checkCellDotColor('Fragmented Cells')
checkCellDotColor('Target Cells')
checkCellDotColor('Echinocytes')
checkCellDotColor('Poikilocytosis')
...
Map<String, String> cellXPaths = [
	'Ovalocytes': "//div[contains(@class, 'reportSummary_pane-body__table-row__name')]/span[text()='Ovalocytes']/parent::div",
	'Elliptocytes': "//div[contains(@class, 'reportSummary_pane-body__table-row__name')]/span[text()='Elliptocytes']/parent::div",
	'Teardrop Cells': "//div[contains(@class, 'reportSummary_pane-body__table-row__name')]/span[text()='Teardrop Cells']/parent::div",
	'Fragmented Cells': "//div[contains(@class, 'reportSummary_pane-body__table-row__name')]/span[text()='Fragmented Cells']/parent::div",
	'Target Cells': "//div[contains(@class, 'reportSummary_pane-body__table-row__name')]/span[text()='Target Cells']/parent::div",
	'Echinocytes': "//div[contains(@class, 'reportSummary_pane-body__table-row__name')]/span[text()='Echinocytes']/parent::div",
	'Poikilocytosis': "//div[contains(@class, 'reportSummary_pane-body__table-row__name')]/span[text()='Poikilocytosis']/parent::div"
...
verifyInSummaryTab('Ovalocytes')
verifyInSummaryTab('Elliptocytes')
verifyInSummaryTab('Teardrop Cells')
verifyInSummaryTab('Fragmented Cells')
verifyInSummaryTab('Target Cells')
verifyInSummaryTab('Echinocytes')
verifyInSummaryTab('Poikilocytosis')
