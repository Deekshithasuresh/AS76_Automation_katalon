...
WebUI.click(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/td_28-Apr-2025, 1248 PM (IST)'))

WebUI.click(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/button_WBC'))

neut_val = WebUI.verifyElementText(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/td_16'), '16')

Lymp_val = WebUI.verifyElementText(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/td_2'), '2')

WebUI.verifyElementPresent(findTestObject('Object Repository/WBC/Page_PBS/Page_PBS/div_NLRNLR  8.0'), 0)
