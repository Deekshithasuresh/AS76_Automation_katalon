...
WebUI.click(findTestObject('Object Repository/WBC_m/Page_PBS/img_Platelets_split-view'))

WebUI.delay(2)


CustomKeywords.'generic.scroll.checkScrollBehaviorBasedOnPatchCountForSplitView'()
