...
// Modify patches - Addding more than 12 patches
...
WebUI.click(findTestObject('Object Repository/Page_PBS/img_Neutrophils_MuiImageListItem-img qa_pat_5739b0'))

WebUI.click(findTestObject('Object Repository/Page_PBS/img_Neutrophils_MuiImageListItem-img qa_pat_30310e'))

WebUI.click(findTestObject('Object Repository/Page_PBS/img_Neutrophils_MuiImageListItem-img qa_pat_f7cf98'))

WebUI.click(findTestObject('Object Repository/Page_PBS/img_Maximum 12 patches can be selected_MuiI_fc007f'))

WebUI.click(findTestObject('Object Repository/Page_PBS/img_Maximum 12 patches can be selected_MuiI_fc007f'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_PBS/div_123456789101112'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_PBS/ul_123456789101112'), 0)
