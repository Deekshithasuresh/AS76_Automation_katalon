...
WebUI.waitForElementVisible(findTestObject('Object Repository/RBC_Objects/Page_PBS/Report_status_drop_down'), 20)
...
lg.selectReportByStatus('Rejected')
