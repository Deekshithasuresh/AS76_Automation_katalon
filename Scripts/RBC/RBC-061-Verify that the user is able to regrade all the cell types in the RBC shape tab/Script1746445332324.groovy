...
lg.assignOrReassignOnTabs('chida')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/RBC_Objects/Page_PBS/button_Shape'), 10)

WebUI.click(findTestObject('Object Repository/RBC_Objects/Page_PBS/button_Shape'))

WebUI.waitForElementPresent(findTestObject('Object Repository/RBC_Objects/Page_PBS/div_Ovalocytes'), 20)
