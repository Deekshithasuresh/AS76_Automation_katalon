...
def rbcColorCellTypes = [
	"Hypochromic Cells","Polychromatic Cells"]

def driver = DriverFactory.getWebDriver()


for (String cellType : rbcColorCellTypes) {
	WebUI.click(findTestObject('Object Repository/CR_Drop_16/Page_PBS/div_dropdown')) 
