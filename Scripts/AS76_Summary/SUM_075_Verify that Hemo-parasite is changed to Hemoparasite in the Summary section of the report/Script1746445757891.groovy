...
def actualHemoparasiteText = WebUI.getText(findTestObject('Object Repository/Summary/span_Hemoparasite'))

// Print comparison between expected and actual
println(('Expected Hemoparasite header text: \'Hemoparasite\', Actual text: \'' + actualHemoparasiteText) + '\'')

// Perform verification with additional logging
if (actualHemoparasiteText == 'Hemoparasite') {
    println('✅ PASS: Hemoparasite header matches expected text')
} else {
    println(('❌ FAIL: Hemoparasite header does not match - Expected: \'Hemoparasite\', Found: \'' + actualHemoparasiteText) + 
        '\'')
}
