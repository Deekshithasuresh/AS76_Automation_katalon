...
String expectedPlateletCountValue = '212'
...
WebUI.verifyElementText(findTestObject('Object Repository/Summary/Page_PBS (1)/div_212'), expectedPlateletCountValue)
...
println "Platelet Count Value: Expected [${expectedPlateletCountValue}] - Actual [${actualPlateletCountValue}] - Match: ${actualPlateletCountValue == expectedPlateletCountValue}"
println "=============================================="

// Print a summary statement
if (actualPlateletLabel == expectedPlateletLabel &&
	actualPlateletCountLabel == expectedPlateletCountLabel &&
	actualPlateletCountValue == expectedPlateletCountValue) {
	println "PASS: All platelet count elements displayed correctly in the summary tab"
} else {
	println "FAIL: One or more platelet count elements did not match the expected values"
}

// Log additional information about the test
WebUI.comment("Verified default text in summary tab: '${actualPlateletCountLabel}' with value '${actualPlateletCountValue}'")
