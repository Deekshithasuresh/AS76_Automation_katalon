...
// Create XPath Test Object
TestObject plateletCountXPath = new TestObject('PlateletCountXPath')
plateletCountXPath.addProperty('xpath', ConditionType.EQUALS, "//span[text()='Platelet count (x 10^9/L)']")

// First Selection - Calculated level
...
WebUI.verifyElementText(findTestObject('Object Repository/Summary/span_Calculated level'), 'Calculated level')
...
// Verify XPath element is NOT present
if (WebUI.verifyElementNotPresent(plateletCountXPath, 10, FailureHandling.OPTIONAL)) {
	println('✅ PASS: Element is NOT present')
	KeywordUtil.markPassed('Test PASSED - Element not found as expected')
} else {
	println('❌ FAIL: Element is present')
	KeywordUtil.markFailed('Test FAILED - Element found when it should not be present')
}

println('==================================================================================================')

// Second Selection - Manual level
WebUI.verifyElementText(findTestObject('Object Repository/Summary/span_Platelets'), 'Platelets')
WebUI.click(findTestObject('Object Repository/Summary/span_Platelets'))
WebUI.verifyElementText(findTestObject('Object Repository/Summary/span_Manual level'), 'Manual level')
WebUI.click(findTestObject('Object Repository/Summary/Page_PBS (1)/input_Significantly decreased_platelet-coun_bb504c'))
WebUI.verifyElementText(findTestObject('Object Repository/Summary/Page_PBS (1)/button_Summary'), 'Summary')
WebUI.click(findTestObject('Object Repository/Summary/Page_PBS (1)/button_Summary'))
